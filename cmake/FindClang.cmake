...
set(_llvm_guess_dirs)

if (APPLE)
  execute_process(COMMAND brew --prefix llvm OUTPUT_VARIABLE _llvm_homebrew_prefix ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE)
  if (_llvm_homebrew_prefix)
    list(APPEND _llvm_guess_dirs "${_llvm_homebrew_prefix}")
  endif()
  message(STATUS "Found homebrew installation of LLVM: ${_llvm_homebrew_prefix}")
endif()
find_package(LLVM CONFIG ${LLVM_FIND_TYPE} QUIET HINTS ${_llvm_guess_dirs})
# if(NOT LLVM_FOUND)
